...
$string['datasource:activeusers'] = 'Utenti attivati (unici per mese)';
...
$string['settings:maxfilteroptions'] = 'Numero massimo di opzioni del filtro';
$string['settings:maxfilteroptions_desc'] = 'Quante opzioni può raccogliere un filtro a tendina quando le sue opzioni '
    . 'provengono dalla scansione delle righe di un report (optionsfield=...). Un menu a tendina su una popolazione '
    . 'ampia — ad esempio tutti gli utenti del sito — richiede un valore superiore ai 500 predefiniti, altrimenti '
    . 'l\'elenco viene troncato silenziosamente; un valore inferiore evita menu a tendina molto lunghi. Le opzioni '
    . 'dichiarate dal filtro di selezione del report non vengono mai limitate.';
