...
$string['completedallexcept:activities_help'] = 'Elenco di attività da escludere, separate da virgola, identificate tramite ID del modulo del corso o tramite numero ID. Individua gli utenti che hanno completato tutte le attività con tracciamento del completamento nel corso, ad eccezione di quelle elencate; l\'operatore più restrittivo richiede inoltre che nessuna delle attività elencate sia completata. Un elenco vuoto disattiva il filtro. Nota che le attività nascoste e le attività con restrizioni di accesso contano comunque come tracciabili, mentre le attività il cui tracciamento del completamento è stato disattivato vengono ignorate del tutto, compresi i completamenti registrati quando era ancora attivo.';
