...
$string['completedallexcept:activities_help'] = 'Kommagetrennte Liste der auszuschließenden Aktivitäten, identifiziert über die Kursmodul-ID oder die ID-Nummer. Erfasst Nutzer/innen, die jede Aktivität mit Abschlussverfolgung im Kurs abgeschlossen haben, mit Ausnahme der aufgelisteten; der strengere Operator verlangt zusätzlich, dass keine der aufgelisteten Aktivitäten abgeschlossen ist. Eine leere Liste deaktiviert den Filter. Beachten Sie, dass verborgene Aktivitäten und Aktivitäten mit Zugriffsbeschränkungen weiterhin als verfolgbar zählen und dass Aktivitäten, deren Abschlussverfolgung abgeschaltet wurde, vollständig ignoriert werden, einschließlich aller Abschlüsse, die erfasst wurden, während sie noch aktiv war.';
