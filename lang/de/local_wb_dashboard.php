...
$string['settings:maxfilteroptions'] = 'Maximale Anzahl Filteroptionen';
$string['settings:maxfilteroptions_desc'] = 'Wie viele Optionen ein Auswahlfilter sammeln darf, wenn seine Optionen '
    . 'aus den Zeilen eines Berichts gelesen werden (optionsfield=...). Eine Auswahlliste über eine große Menge — etwa '
    . 'alle Nutzerinnen und Nutzer der Website — braucht einen höheren Wert als die voreingestellten 500, sonst wird '
    . 'die Liste stillschweigend abgeschnitten; ein niedrigerer Wert hält sehr lange Auswahllisten von der Seite fern. '
    . 'Optionen, die der Bericht in seinem eigenen Auswahlfilter deklariert, werden nie begrenzt.';
